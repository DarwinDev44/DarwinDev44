...
> Proyectos públicos que puedes explorar y probar en vivo.

<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">📊 <a href="https://github.com/DarwinDev44/Gobierno-de-Datos">Gobierno de Datos — UdeC</a></h3>
      <p>Micrositio institucional que centraliza la gestión y visualización de indicadores de la Universidad de Cundinamarca: integra <strong>61 tableros de Power BI</strong>, métricas en tiempo real, georreferenciación y navegación por roles.</p>
      <p align="center">
      ...
      <p align="center">
        <a href="https://gobierno-de-datos.vercel.app/"><img src="https://img.shields.io/badge/🌐_Live_Demo-00d4ff?style=flat-square" alt="Live Demo"/></a>
        <a href="https://github.com/DarwinDev44/Gobierno-de-Datos"><img src="https://img.shields.io/badge/Code-181717?style=flat-square&logo=github&logoColor=white" alt="Code"/></a>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3 align="center">🗺️ <a href="https://github.com/DarwinDev44/Mapa-de-Calor-2">Mapa de Calor Interactivo</a></h3>
      <p>Visualización geoespacial de datos mediante mapas de calor con capas de información dinámicas, renderizado en tiempo real y filtros configurables. JavaScript vanilla, sin dependencias.</p>
      <p align="center">
        <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" alt="JS"/>
        <img src="https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white" alt="HTML"/>
      ...
      <p align="center">
        <a href="https://darwindev44.github.io/Mapa-de-Calor-2/"><img src="https://img.shields.io/badge/🌐_Live_Demo-00d4ff?style=flat-square" alt="Live Demo"/></a>
        <a href="https://github.com/DarwinDev44/Mapa-de-Calor-2"><img src="https://img.shields.io/badge/Code-181717?style=flat-square&logo=github&logoColor=white" alt="Code"/></a>
      </p>
    </td>
  </tr>
  <tr>
...
## 🔒 Private & Institutional Work

> Sistemas institucionales en producción. El código es privado; aquí comparto el alcance técnico.

<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">🎓 Sistema de Elaboración de Diplomas</h3>
      <p align="center"><img src="https://img.shields.io/badge/Private-8b949e?style=flat-square&logo=github&logoColor=white" alt="Private"/> <strong>v7.0.0</strong> · App de escritorio</p>
      <p>Generación automatizada de diplomas universitarios: procesa Excel de graduados, normaliza datos con <em>fuzzy matching</em> (Levenshtein), exporta CSV y se integra con <strong>Adobe Illustrator</strong> vía automatización <strong>COM</strong> para imprimir.</p>
      <p align="center">
    ...
    <td width="50%" valign="top">
      <h3 align="center">📋 Sistema de Novedades Académicas</h3>
      <p align="center"><img src="https://img.shields.io/badge/Private-8b949e?style=flat-square&logo=github&logoColor=white" alt="Private"/> <strong>v5.0.0</strong> · Fullstack desktop</p>
      <p>Gestión de 10+ tipos de trámites académicos. Frontend <strong>React + TS + Material UI</strong>, backend <strong>Electron + Node.js</strong>, <strong>SQLite</strong> local con sync a <strong>Supabase</strong>, cifrado <strong>AES-256-GCM</strong> y pipeline de calidad <strong>Vitest + SonarQube</strong>.</p>
      <p align="center">
        ...
        <img src="https://img.shields.io/badge/Supabase-3ECF8E?style=flat-square&logo=supabase&logoColor=white" alt="Supabase"/>
        <img src="https://img.shields.io/badge/SonarQube-4E9BCD?style=flat-square&logo=sonarqube&logoColor=white" alt="Sonar"/>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">🎙️ Generador de Actas</h3>
      <p align="center"><img src="https://img.shields.io/badge/Private-8b949e?style=flat-square&logo=github&logoColor=white" alt="Private"/> · IA · App de escritorio</p>
      <p>Transcripción de audio y generación automática de actas en Word mediante IA (<strong>Whisper</strong> + <strong>Groq / OpenAI</strong>). Arquitectura monorepo con TypeScript, validación de API keys y build para Windows.</p>
      <p align="center">
        <img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white" alt="TS"/>
        <img src="https://img.shields.io/badge/Electron-2C2E3B?style=flat-square&logo=electron&logoColor=9FEAF9" alt="Electron"/>
    ...
    <td width="50%" valign="top">
      <h3 align="center">🧰 More Institutional Tools</h3>
      <ul align="left">
        <li><strong>Seguimiento POAI</strong> — Tracking del Plan Operativo Anual de Inversiones (Electron + SQLite)</li>
        <li><strong>Control Académico CAO</strong> — Gestión de actos académicos y sesiones (Python)</li>
        <li><strong>Dispatch</strong> — Automatizador de mensajes programados para VS Code</li>
        <li><strong>AutoApagado</strong> — Gestión de energía de Windows por horarios y hardware</li>
      </ul>
    </td>
  </tr>
</table>
...
&nbsp;&nbsp;
<!-- Mezcla de lenguajes (incluye trabajo privado) — snapshot manual; actualizar al cambiar el stack -->
